...
const Terms = () => (
  <Topics>
    <section>
      <h2>Termos</h2>
      <p>
        Ao acessar ao site ALIS, concorda em cumprir estes termos de serviço, todas as leis e
        ...
        acessar este site. Os materiais contidos neste site estão em{" "}
    ...
    <section>
      ...
      <p>
        O ALIS está distribuído sobre a licença{" "}
    ...
    <section>
      ...
      <p>
        Os materiais no site da ALIS são fornecidos &lsquo;como estão&rsquo;. ALIS não oferece
      ...
      <p>
        Além disso, o ALIS não garante ou faz qualquer representação relativa à precisão, aos
    ...
    <section>
      ...
      <p>
        ...
        negócios) decorrentes do uso ou da incapacidade de usar os materiais em ALIS, mesmo que ALIS
        ou um representante autorizado da ALIS tenha sido notificado oralmente ou por escrito da
        possibilidade de tais danos.
      </p>
      <p>
        Como algumas jurisdições não permitem limitações em garantias implícitas, ou limitações de
        responsabilidade por danos consequentes ou incidentais, essas limitações podem não se
        aplicar a você.
      </p>
    </section>
    <section>
      ...
      <p>
        Os materiais exibidos no site da ALIS podem incluir erros técnicos, tipográficos ou
        fotográficos. ALIS e seus contribuidores não garantem que qualquer material em seu site seja
        preciso, completo ou atual. ALIS pode fazer alterações nos materiais contidos em seu site a
        qualquer momento, sem aviso prévio. No entanto, ALIS não se compromete a atualizar os
        materiais.
      </p>
    </section>
    <section>
      <h2>Links</h2>
      <p>
        O ALIS não analisou todos os sites vinculados ao seu site e não é responsável pelo conteúdo
        de nenhum site vinculado. A inclusão de qualquer link não implica endosso por ALIS do site.
    ...
    <section>
      <h2>Modificações</h2>
      <p>
        O ALIS pode revisar estes termos de serviço do site a qualquer momento, sem aviso prévio. Ao
    ...
    <section>
      <h2>Lei aplicável</h2>
      <p>
        Estes termos e condições são regidos e interpretados de acordo com as leis do ALIS e você se
