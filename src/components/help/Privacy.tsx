  ...
  <Topics>
    <section>
      ...
      <p>
        ...
        relação a qualquer informação sua que possamos coletar no site <Link href="/">ALIS</Link>, e
      ...
      <p>
        ...
        um serviço. Fazemos por meios justos e legais, com o seu conhecimento e consentimento.
    ...
    <section>
      ...
      <p>
        ...
        disponíveis ou funcionar corretamente se você não permitir que os cookies sejam armazenados
        no seu computador.
      </p>
    </section>
    ...
    <section>
      ...
      <ol>
        ...
        <li>
          ...
          outros sistemas de hardware ou software que sejam capazes de causar os danos anteriormente
          mencionados.
        </li>
      </ol>
    </section>
